...
const ProjectsSection = () => {
  ...
  const scrollToProjects = () => {
    ...
    if (element) {
      const headerOffset = 76; // Assuming header height is 76px
  ...
  return (
    <section id="projects" className="py-16 bg-gradient-to-r from-blue-500 via-teal-500 to-gray-500">
      <div className="container mx-auto px-4">
        <h2
          className="text-4xl font-bold text-center mb-12 text-white cursor-pointer"
